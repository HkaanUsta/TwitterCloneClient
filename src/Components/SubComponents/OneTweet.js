...
export default function OneTweet() {
    return (
        <div className="one-tweet">
            <div className="user-nameAnduser-tag">
                <h3 className="user-name">Enes Pınar</h3>
                <h3 className="user-tag">@ensePNR</h3>
            </div>
            <div className="tweet-content">
                <h2>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut eum ratione in.</h2>
            </div>
