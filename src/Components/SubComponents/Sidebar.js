        ...
        <div className="col-md-3 header">
            ...
            <div className="header-list">
                <ul>
                    ...
                    <li>
                        <Link to="/explore">
                            <svg xmlns="http://www.w3.org/2000/svg" width={23} height={23} fill="currentColor" className="bi bi-binoculars" viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="/messages">
                            <svg xmlns="http://www.w3.org/2000/svg" width={23} height={23} fill="currentColor" className="bi bi-chat-left-text" viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="/bookmarks">
                            <svg xmlns="http://www.w3.org/2000/svg" width={23} height={23} fill="currentColor" className="bi bi-bookmarks" viewBox="0 0 16 16">
            ...
            <div className="header-profile">
                <div className="header-proifile-image">
                    <img src="https://www.palmcityyachts.com/wp/wp-content/uploads/palmcityyachts.com/2015/09/default-profile.png" width="40px" height="40px" alt="" />
                </div>
                <div className="header-profile-name-id">
